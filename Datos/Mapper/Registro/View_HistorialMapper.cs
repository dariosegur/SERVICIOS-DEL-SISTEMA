...
{
        public Dtos.Registro.View_Historial Mapper(Datos.View_Historial Origen)
        {
            var Destino = new Dtos.Registro.View_Historial();
        ...
        public Datos.View_Historial Mapper(Dtos.Registro.View_Historial Origen)
        {
